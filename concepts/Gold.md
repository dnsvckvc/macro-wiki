...
Precious metal; historical reserve asset and currency. In the wiki context, treated primarily as a **central-bank diversification trade** driven by structural reserve rebalancing rather than by inflation, real rates, or DXY.

## March 2026 setup
- Gold corrected **~27% from the highs** into late March 2026 — unusual given an active Middle East war typically supports gold.
- Per [[KevinMuir]] in [[buying-gold-again]], the correction was a positioning unwind:
  - Too many speculators were crowded long going into the war and were forced to sell what they were overweight.
  - Gulf nations who held gold had cash calls and liquidated.
  - The [[PBOC]] — whose objective is to *maximize long-run accumulation, not chase price* — rationally *stepped away* from the market during the mania phase and is expected to resume buying now that the shakeout is done.
...
## Rozencwajg's two-trade framework (per [[macrovoices-527-adam-rozencwajg]])
[[AdamRozencwajg]] frames the gold cycle as two sequential trades:
1. **The debasement trade** (current) — driven by central bank diversification ([[PBOC]], etc.) and monetary expansion. This is the phase we're in now.
2. **The insolvency trade** (1–3 years out) — driven by governments' fiscal distress coming into focus. *"A lot of these governments are in really, really tough shape."* This is the next leg higher.

Between the two, oil is likely to outperform gold for "a couple of years" — precedent from the 1970s and early 2000s where energy leads in the middle part of commodity bull markets. Speculative GLD inflows (4Q25/1Q26 momentum money) create near-term reversal risk. *"Gold could probably double from here"* but not yet — the insolvency catalyst hasn't arrived.
